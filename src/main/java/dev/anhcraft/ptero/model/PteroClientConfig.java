...
public class PteroClientConfig extends AbstractDescribableImpl<PteroClientConfig> {
    ...
    public static class DescriptorImpl extends Descriptor<PteroClientConfig> {
        ...
        @RequirePOST
        public FormValidation doCheckId(@QueryParameter String id) throws IOException, ServletException {
            ...
            //  return
            // FormValidation.error(Messages.PteroClientConfig_DescriptorImpl_errors_duplicatedID());
            // }
